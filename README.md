...
[![Docker Build](https://img.shields.io/github/actions/workflow/status/effectindex/tripreporter/codeql.yml?logo=docker&logoColor=white&branch=master)](https://github.com/effectindex/tripreporter/actions/workflows/codeql.yml)
